...
$sql = "SELECT product_id, product_name, price, product_imgpath FROM oms.products where category='laptops'";
$result = $conn->query($sql);

// Start generating HTML form and table
echo '<!DOCTYPE html>';
echo '<html>';
echo '<head>';
...
echo '}';
echo 'img {';
echo '    max-width: 160px; /* Limit image width */';
...
echo '  <li><a  href="mobiles.php">Mobiles</a></li>';
echo '  <li><a class="active" href="laptops.php">Laptops</a></li>';
